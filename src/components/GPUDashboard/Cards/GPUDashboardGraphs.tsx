    ...
    <Grid hasGutter>
      <GridItem span={3}>
        <MetricsCard
          ...
          query={`sum(DCGM_FI_PROF_GR_ENGINE_ACTIVE{UUID="${selectedGPU?.uuid}"})[60m:5m]`}
          maxDomain={100}
      ...
      <GridItem span={3}>
        <MetricsCard
          ...
          query={`DCGM_FI_DEV_MEM_COPY_UTIL{UUID="${selectedGPU?.uuid}"}[60m:5m]`}
          maxDomain={100}
      ...
      <GridItem span={3}>
        <MetricsCard
          ...
          query={`DCGM_FI_DEV_ENC_UTIL{UUID="${selectedGPU?.uuid}"}[60m:5m]`}
          maxDomain={100}
          humanize={humanizePercentage}
          loading={gpusLoading}
          error={error}
      ...
      <GridItem span={3}>
        <MetricsCard
          ...
          query={`DCGM_FI_DEV_DEC_UTIL{UUID="${selectedGPU?.uuid}"}[60m:5m]`}
          maxDomain={100}
          humanize={humanizePercentage}
          loading={gpusLoading}
          error={error}
      ...
      <GridItem span={3}>
        <MetricsCard
          ...
          query={`DCGM_FI_DEV_POWER_USAGE{UUID="${selectedGPU?.uuid}"}[60m:5m]`}
      ...
      <GridItem span={3}>
        <MetricsCard
          ...
          query={`DCGM_FI_DEV_GPU_TEMP{UUID="${selectedGPU?.uuid}"}[60m:5m]`}
          maxDomain={110}
      ...
      <GridItem span={3}>
        <MetricsCard
          ...
          query={`DCGM_FI_DEV_SM_CLOCK{UUID="${selectedGPU?.uuid}"}[60m:5m]`}
      ...
      <GridItem span={3}>
        <MetricsCard
          ...
          query={`DCGM_FI_DEV_MEM_CLOCK{UUID="${selectedGPU?.uuid}"}[60m:5m]`}
